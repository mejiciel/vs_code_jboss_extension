...
export class JbossSeverTreeProvider implements vscode.TreeDataProvider<TreeItem> {
    ...
    constructor(private _context: vscode.ExtensionContext, private _tomcatModel: JbossModel) {
    ...
    public async getChildren(element?: TreeItem): Promise<TreeItem[]> {
        if (!element) {
            return this._tomcatModel.getServerSet().map((server: JbossServer) => {
            ...
            const server: JbossServer = <JbossServer>element;
